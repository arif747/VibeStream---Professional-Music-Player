...
export const mockSongs: Song[] = [
  {
    ...
    file_url: 'https://actions.google.com/sounds/v1/science_fiction/glitchy_digital_interface.ogg',
    genre: 'Ska',
    play_count: 85420,
    artist_name: 'Tipe-X',
  ...
  },
  {
    ...
    file_url: 'https://actions.google.com/sounds/v1/alarms/alarm_clock_beeping.ogg',
    genre: 'Ska',
    play_count: 92150,
    artist_name: 'Tipe-X',
    cover_art: 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=400&h=400&fit=crop'
  },
  {
    ...
    file_url: 'https://actions.google.com/sounds/v1/foley/beating_drum.ogg',
    genre: 'Pop Rock',
    play_count: 154200,
  ...
  },
  {
    ...
    file_url: 'https://actions.google.com/sounds/v1/human/shuffling_feet.ogg',
    genre: 'Rap Rock',
    play_count: 75300,
    artist_name: 'Bondan Prakoso & Fade 2 Black',
    cover_art: 'https://images.unsplash.com/photo-1459749411177-042180ce673c?w=400&h=400&fit=crop'
  },
  {
    ...
    title: 'Neon Horizon',
    duration_seconds: 215,
    file_url: 'https://actions.google.com/sounds/v1/science_fiction/teleport_beam.ogg',
    genre: 'Synthwave',
    play_count: 1542,
  ...
  },
  {
    ...
    file_url: 'https://actions.google.com/sounds/v1/science_fiction/industrial_shudder.ogg',
    genre: 'Synthwave',
    play_count: 2305,
    artist_name: 'Neon Echo',
    cover_art: 'https://picsum.photos/seed/alb1/400/400'
